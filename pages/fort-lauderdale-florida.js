...
class FortLauderdale extends React.Component {
	...
	render() {
		...
		return <div className="single-article-page">
					<Meta 
						title="Fort Lauderdale Florida | Areas Served | Proper Noun" 
						desc="Proper Noun is located in Fort Lauderdale, FL. While we work with companies around the world, we take meetings in Downtown, Fort Lauderdale." 
						canonical='https://www.propernoun.co/fort-lauderdale-florida'
					/>
