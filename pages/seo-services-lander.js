...
import AuditForm from '../partials/website-audit-form.js'
...
class SingleService extends React.Component {
	...
	static async getInitialProps(ctx) {				
	    ...
	    const service = await fetch('//cms.propernoun.co/wp-json/wp/v2/seo_services/?slug=' + ctx.req.params.slug)
	    const serviceError = service.statusCode > 200 ? service.statusCode : false;
	    const serviceData = await service.json(); 
		
		let url = 'https://' + ctx.req.headers.host + '/seo/' + ctx.req.params.slug
