...
const WebsiteAuditForm = (props) => (	    	
    	<form action="" className="ui-form form-submit" id="main-contact-form" data-form-id="7" >
			...
			<input type="hidden" id="submitted_page" name="submitted_page" placeholder="Your Website URL" className="ui-input fluid" value={props.pagename} />		
